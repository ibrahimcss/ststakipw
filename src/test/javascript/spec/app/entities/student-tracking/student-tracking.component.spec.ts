...
import { StudentTrackingComponent } from 'app/entities/student-tracking/student-tracking.component';
...
describe('Component Tests', () => {
  describe('StudentTracking Management Component', () => {
    let comp: StudentTrackingComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [StudentTrackingComponent],
        providers: [
          {
        ...
        .overrideTemplate(StudentTrackingComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.studentTrackings && comp.studentTrackings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
