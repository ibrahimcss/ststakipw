...
import { TravelPathComponent } from 'app/entities/travel-path/travel-path.component';
...
describe('Component Tests', () => {
  describe('TravelPath Management Component', () => {
    let comp: TravelPathComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TravelPathComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.travelPaths && comp.travelPaths[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
