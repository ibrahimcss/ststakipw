...
public class NotificationResourceIT {
    ...
    private static final NotifyType DEFAULT_TYPE = NotifyType.Info;
    private static final NotifyType UPDATED_TYPE = NotifyType.Campaign;
     ...
     *
     * @see com.sts.repository.search.NotificationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createNotification() throws Exception {
        ...
        assertThat(testNotification.getUrlImage()).isEqualTo(DEFAULT_URL_IMAGE);
    ...
    public void updateNotification() throws Exception {
        ...
        assertThat(testNotification.getUrlImage()).isEqualTo(UPDATED_URL_IMAGE);
